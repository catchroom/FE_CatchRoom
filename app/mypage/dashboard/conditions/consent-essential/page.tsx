...
const Page = () => {
  return (
    <div className="w-full relative p-5 flex flex-col gap-5 h-[calc(100vh-53px)] overflow-x-scroll bg-surface">
      <div className="w-full overflow-x-scroll">
        <div className="flex flex-col border border-border-sub w-[960px]">
          <ul className=" bg-surface-gray grid grid-cols-12 divide-x divide-gray-300 border-b border-gray-300">
            <li className="col-span-3   p-5 w-20">구분</li>
            <li className="col-span-3   p-5">수집 목적</li>
            <li className="col-span-3  p-5">수집 항목</li>
            <li className="col-span-3   p-5">보유 및 이용 기간</li>
          </ul>
          <ul className=" bg-surface grid grid-cols-12 divide-x divide-gray-300">
            <li className="col-span-3 p-5">필수</li>
            ...
            <li className="col-span-3 p-5">
              [회원가입 시]
              <br />
              휴대전화번호, 이메일, 이름, 생년월일, 비밀번호(이메일로 가입 시),
              닉네임
              <br />
              [SNS가입 시]
              <br />
