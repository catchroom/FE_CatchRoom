...
const Footer = () => {
  return (
    <div className="flex flex-col gap-3 mt-10 pb-20">
      <div className="flex flex-col text-text-sub lg:text-p3 md:text-p4 sm:text-p4 ">
        <h1 className="pb-1 font-bold lg:text-p1 md:text-p3 sm:text-p3">
          캐치룸
        </h1>
        <p>
      ...
      <div className="flex gap-[19px] text-text-secondary underline decoration-solid lg:text-p2 md:text-[11px] sm:text-[11px]">
      ...
      <div className="lg:text-t4 text-text-sub md:text-p4 sm:text-p4">
