...
const BottomSheetsContent = ({ price }: PropsType) => {
  ...
  return (
    <div className="flex flex-col gap-8 h-full max-h-[560px] overflow-y-scroll mt-8">
      <div>
      ...
      <div className="flex flex-col gap-2.5 px-4 py-3 rounded bg-surface-sub border border-border-sub mb-10">
