  ...
  return (
    <div className="flex flex-col w-full p-4 gap-5 bg-white border border-border-sub rounded">
      <div className="flex gap-5 w-full">
        <div className="lg:w-[100px] lg:h-[100px] md:w-[80px] md:h-[80px] sm:w-[80px] sm:h-[80px] w-[80px] h-[80px] relative flex-shrink-0">
          <Image
        ...
        <div className="flex flex-col">
          <p className="font-semibold text-h5 lg:whitespace-normal md:whitespace-nowrap md:overflow-hidden md:text-ellipsis md:w-[154px] sm:whitespace-nowrap sm:overflow-hidden sm:text-ellipsis sm:w-[154px] whitespace-nowrap overflow-hidden text-ellipsis w-[154px]">
            {data?.accommdationName}
          </p>
          <p className="font-semibold text-t2 opacity-50 lg:whitespace-normal md:whitespace-nowrap md:overflow-hidden md:text-ellipsis md:w-[154px] sm:whitespace-nowrap sm:overflow-hidden sm:text-ellipsis sm:w-[154px] whitespace-nowrap overflow-hidden text-ellipsis w-[154px]">
            {data?.roomType}
          </p>
